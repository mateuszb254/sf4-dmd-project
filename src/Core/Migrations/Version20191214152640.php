 ...
 */
final class Version20191214152640 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE characters (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, name VARCHAR(30) NOT NULL, level VARCHAR(30) DEFAULT \'1\' NOT NULL, ht INT DEFAULT 0 NOT NULL, dx INT DEFAULT 0 NOT NULL, st INT DEFAULT 0 NOT NULL, iq INT DEFAULT 0 NOT NULL, job INT DEFAULT 0 NOT NULL, alignment INT DEFAULT 0 NOT NULL, playtime INT DEFAULT 0 NOT NULL, horse_level INT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_3A29410E5E237E06 (name), INDEX IDX_3A29410E9B6B5FBA (account_id), INDEX search (level), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE characters_index (id INT NOT NULL, pid1 INT DEFAULT 0 NOT NULL, pid2 INT DEFAULT 0 NOT NULL, pid3 INT DEFAULT 0 NOT NULL, pid4 INT DEFAULT 0 NOT NULL, pid5 INT DEFAULT 0 NOT NULL, empire INT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE characters ADD CONSTRAINT FK_3A29410E9B6B5FBA FOREIGN KEY (account_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE characters_index ADD CONSTRAINT FK_A1141BE6BF396750 FOREIGN KEY (id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE gmlist ADD CONSTRAINT FK_A01D0AB91136BE75 FOREIGN KEY (character_id) REFERENCES characters (id)');
        $this->addSql('ALTER TABLE guild_member ADD CONSTRAINT FK_7FD58C975550C4ED FOREIGN KEY (pid) REFERENCES characters (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE characters DROP FOREIGN KEY FK_3A29410E9B6B5FBA');
        $this->addSql('ALTER TABLE characters_index DROP FOREIGN KEY FK_A1141BE6BF396750');
        ...
        $this->addSql('DROP TABLE characters_index');
